...
function title() {
    console.log(chalk.bold.green(figlet.textSync('Dirly Bot', {
        font: 'Standard',
...
function uncache(module = '.') {
    ...
    const haruka = harukaConnect({
      version,
        ...
        browser: ['Dirly Multi Device','Safari','1.0.0'],
        auth: state
    })
